...
const AboutSection = () => {
  ...
  return (
    <Section ref={aboutSectionRef} id="about" className="bg-pastel-surface/90 backdrop-blur-sm transition-colors duration-500">
      <div ref={aboutContentRef} className="flex flex-col items-center max-w-4xl mx-auto opacity-0">
        <h2 className="about-heading font-pixel text-3xl sm:text-4xl mb-6 inline-flex items-center gap-3 text-center text-pastel-charcoal">
          <span className="w-3 h-8 sm:h-10 bg-pastel-peach border-2 border-pastel-charcoal"></span>
          About Me
        </h2>

        <div className="about-desc text-center mb-12">
        ...
        <div className="about-stats-grid grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-4 w-full">
          {[
